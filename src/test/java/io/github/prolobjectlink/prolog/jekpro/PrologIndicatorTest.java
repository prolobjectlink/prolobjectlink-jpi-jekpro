...
import io.github.prolobjectlink.prolog.jekpro.JekejekePrologIndicator;

public class PrologIndicatorTest extends PrologBaseTest {

	private final PrologIndicator pi = new JekejekePrologIndicator("functor", 3);
	...
	public final void testHashCode() {
		assertEquals(new JekejekePrologIndicator("functor", 3).hashCode(), pi.hashCode());
	}

	@Test
	public final void testEquals() {
		assertEquals(new JekejekePrologIndicator("functor", 3), pi);
	}
