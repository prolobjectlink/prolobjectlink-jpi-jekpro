...
public class PrologEngineTest extends PrologBaseTest {
	...
	public final void testCurrentPredicates() {
		Set<JekejekePrologIndicator> builtins = new HashSet<JekejekePrologIndicator>();
	...
	public final void testGetVersion() {
		assertEquals("1.3.6", engine.getVersion());
	}

	@Test
	public final void testGetName() {
		assertEquals("Jekejeke Prolog", engine.getName());
	}
