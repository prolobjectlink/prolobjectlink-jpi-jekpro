...
import io.github.prolobjectlink.prolog.jekpro.JekejekeProlog;
import io.github.prolobjectlink.prolog.jekpro.JekejekePrologConverter;
...
public class PrologProviderTest extends PrologBaseTest {
	...
	public final void testToString() {
		...
		assertEquals(JekejekeProlog.class.getSimpleName() + " [converter="
				+ JekejekePrologConverter.class.getSimpleName() + "]", provider.toString());
