...
class JekejekePrologClauses extends AbstractList<PrologClause> implements PrologClauses {

	private final int arity;
	private final String functor;
	private final List<PrologClause> list;

	JekejekePrologClauses(String functor, int arity) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JekejekePrologClauses other = (JekejekePrologClauses) obj;
		if (list == null) {
			if (other.list != null)
				return false;
