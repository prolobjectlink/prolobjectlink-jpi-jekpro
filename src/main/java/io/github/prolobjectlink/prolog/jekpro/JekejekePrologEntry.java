 ...
 * @since 1.1
 */
public final class JekejekePrologEntry extends AbstractCompounds implements PrologEntry {

	private final PrologTerm key;
	private PrologTerm value;

	JekejekePrologEntry(PrologProvider provider, PrologTerm key, PrologTerm value) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JekejekePrologEntry other = (JekejekePrologEntry) obj;
		if (key == null) {
			if (other.key != null)
				return false;
