 ...
 * @since 1.0
 */
final class JekejekePrologOperator extends AbstractOperator implements PrologOperator {

	JekejekePrologOperator(int priority, String specifier, String operator) {
